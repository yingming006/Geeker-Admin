...
export const loginApi = (params: Login.ReqLoginForm) => {
  return http.post<Login.ResLogin>("/system/auth/login", params, { noLoading: true }); // 正常 post json 请求  ==>  application/json
...
export const getAuthMenuListApi = () => {
  ...
  return http.get<Menu.MenuOptions[]>("/system/auth/list-menus", {});
};
...
export const getTenantIdByName = (name: string) => {
  return http.get("/system/tenant/get-id-by-name?name=" + name);
};
